...
Jeg har tenkt slik:
+ I kretsen fra oppgave 4 ser vi at F er helt uavhengig av A.
+ F er logisk ekvivalent med B.
+ C(carry) representerer tallet $10_2$($2_{10}$), og vil kun aktiveres dersom 2 eller flere av inputene X, Y og Z er på.
...
#figure(image("../../imgs/week4-task5-2.png", width: 50%), caption: [Screenshot av en full adder modifisert til å fungere som kretsen i oppgave 4. A=0, B=1, F=C=1])

#figure(image("../../imgs/week4-task5-3.png", width: 50%), caption: [Screenshot av en full adder modifisert til å fungere som kretsen i oppgave 4. A=1, B=0, F=C=0])

#figure(image("../../imgs/week4-task5-4.png", width: 50%), caption: [Screenshot av en full adder modifisert til å fungere som kretsen i oppgave 4. A=1, B=1, F=C=1])
