...
#figure(image("../../imgs/week5-task7-1.png", width: 50%), caption: [Det endrede programmet (se linje 0000 & 0005)])

#figure(image("../../imgs/week5-task7-2.png", width: 50%), caption: [Registrene etter kjøring])
